...
cmake -DWITH="DV;BN;MD;FP;EP;FPX;EPX;PP;PC" -DCHECK=off -DARITH=gmp -DARCH=ARM -DCOLOR=off -DOPSYS=DROID -DFP_PRIME=158 -DFP_QNRES=off -DFP_METHD="INTEG;INTEG;INTEG;MONTY;EXGCD;SLIDE" -DFPX_METHD="INTEG;INTEG;LAZYR" -DPP_METHD="LAZYR;OATEP" -DCOMP="-O3 -funroll-loops -fomit-frame-pointer -I$(NDK)/platforms/android-14/arch-arm/usr/include" -DLINK="-L/opt/android-ndk/platforms/android-14/arch-arm/usr/lib/ -llog" -DTIMER=HREAL -DWORD=32 -DSTLIB=on -DSHLIB=off -DGMP_FOUND=TRUE -DGMP_LIBRARIES=$MY_GMP_PATH/lib/libgmp.a -DGMP_INCLUDE_DIR=$MY_GMP_PATH/include $1
