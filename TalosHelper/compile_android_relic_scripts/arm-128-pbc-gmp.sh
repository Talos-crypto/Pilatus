...
MY_GMP_PATH=/home/lubu/Documents/TalosJob/gmp-6.1.1/android_lib
...
cmake -DWITH="ALL" -DCHECK=off -DARITH=gmp -DARCH=ARM -DCOLOR=off -DOPSYS=DROID -DSEED=ZERO -DSHLIB=off -DFP_PRIME=254 -DFP_QNRES=on -DFP_METHD="INTEG;INTEG;INTEG;MONTY;EXGCD;SLIDE" -DFPX_METHD="INTEG;INTEG;LAZYR" -DPP_METHD="LAZYR;OATEP" -DCOMP="-O3 -funroll-loops -fomit-frame-pointer -I/opt/android-ndk/platforms/android-14/arch-arm/usr/include" -DLINK="-L/opt/android-ndk/platforms/android-18/arch-arm/usr/lib/ -llog" -DTIMER=HREAL -DWORD=32 -DSTLIB=on -DGMP_FOUND=TRUE -DGMP_LIBRARIES=$MY_GMP_PATH/lib/libgmp.a -DGMP_INCLUDE_DIR=$MY_GMP_PATH/include $1
